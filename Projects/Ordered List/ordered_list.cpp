...
Ordered_list::Ordered_list() // Set all pointers to NULL (head, current, and
                             // temp)
{
...
void Ordered_list::insert(int insertData) {
  node *newNode = new node{insertData = insertData, newNode = NULL};
...
void Ordered_list::remove(
    int removeData) // Pass in data that will be stored in "removeData"
{
...
bool Ordered_list::is_empty() { return count() == 0; }
